...
//                     <input type="text" className="w-full bg-[#0b1226] border border-gray-700 rounded-lg p-3 text-white focus:outline-none focus:border-cyan-400 transition-colors" placeholder="John" />
//                   </div>
//                   <div>
//                     <label className="block text-gray-400 text-sm mb-2">Last Name</label>
//                     <input type="text" className="w-full bg-[#0b1226] border border-gray-700 rounded-lg p-3 text-white focus:outline-none focus:border-cyan-400 transition-colors" placeholder="Doe" />
//                   </div>
//                 </div>

//                 <div>
//                    <label className="block text-gray-400 text-sm mb-2">Email Address</label>
//                    <input type="email" className="w-full bg-[#0b1226] border border-gray-700 rounded-lg p-3 text-white focus:outline-none focus:border-cyan-400 transition-colors" placeholder="john@example.com" />
//                 </div>
